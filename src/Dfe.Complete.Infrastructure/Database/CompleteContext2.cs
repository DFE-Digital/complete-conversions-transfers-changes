...
public partial class CompleteContext2 : DbContext
{
    ...
    public CompleteContext2()
    {
    }

    public CompleteContext2(DbContextOptions<CompleteContext> options, IConfiguration configuration, IServiceProvider serviceProvider)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ArInternalMetadata>(ConfigureArInternalMetadata);
    ...
    {
        projectConfiguration.HasKey(e => e.Id).HasName("PK__projects__3213E83F1AF5857D");
        ...
        projectConfiguration.Property(e => e.AcademyUrn).HasColumnName("academy_urn");
        ...
        projectConfiguration.Property(e => e.AssignedToId).HasColumnName("assigned_to_id");
        projectConfiguration.Property(e => e.CaseworkerId).HasColumnName("caseworker_id");
        ...
        projectConfiguration.Property(e => e.EstablishmentMainContactId).HasColumnName("establishment_main_contact_id");
        ...
        projectConfiguration.Property(e => e.IncomingTrustMainContactId).HasColumnName("incoming_trust_main_contact_id");
        projectConfiguration.Property(e => e.IncomingTrustSharepointLink).HasColumnName("incoming_trust_sharepoint_link");
        projectConfiguration.Property(e => e.IncomingTrustUkprn).HasColumnName("incoming_trust_ukprn");
        projectConfiguration.Property(e => e.LocalAuthorityMainContactId).HasColumnName("local_authority_main_contact_id");
        projectConfiguration.Property(e => e.MainContactId).HasColumnName("main_contact_id");
        ...
        projectConfiguration.Property(e => e.OutgoingTrustMainContactId).HasColumnName("outgoing_trust_main_contact_id");
        projectConfiguration.Property(e => e.OutgoingTrustSharepointLink).HasColumnName("outgoing_trust_sharepoint_link");
        projectConfiguration.Property(e => e.OutgoingTrustUkprn).HasColumnName("outgoing_trust_ukprn");
        projectConfiguration.Property(e => e.PrepareId).HasColumnName("prepare_id");
        projectConfiguration.Property(e => e.Region)
            .HasMaxLength(4000)
            .HasColumnName("region");
        projectConfiguration.Property(e => e.RegionalDeliveryOfficerId).HasColumnName("regional_delivery_officer_id");
    ...
    {
        projectConfiguration.HasKey(e => e.Id).HasName("PK__users__3213E83F2884685E");
    ...
    {
        projectConfiguration.HasKey(e => e.Id).HasName("PK__contacts__3213E83F5AC83AE6");
        ...
        projectConfiguration.Property(e => e.LocalAuthorityId).HasColumnName("local_authority_id");
        ...
        projectConfiguration.Property(e => e.Phone)
            .HasMaxLength(4000)
            .HasColumnName("phone");
        projectConfiguration.Property(e => e.ProjectId).HasColumnName("project_id");
    ...
    private static void ConfigureArInternalMetadata(EntityTypeBuilder<ArInternalMetadata> projectConfiguration)
    {
        projectConfiguration.HasKey(e => e.Key).HasName("PK__ar_inter__DFD83CAE30D055CC");

        projectConfiguration.ToTable("ar_internal_metadata", "complete");

        projectConfiguration.Property(e => e.Key)
            .HasMaxLength(4000)
            .HasColumnName("key");
        projectConfiguration.Property(e => e.CreatedAt)
            .HasPrecision(6)
        ...
        projectConfiguration.Property(e => e.UpdatedAt)
            .HasPrecision(6)
            .HasColumnName("updated_at");
        projectConfiguration.Property(e => e.Value)
            .HasMaxLength(4000)
            .HasColumnName("value");
    }
    ...
    {
        projectConfiguration.HasKey(e => e.Id).HasName("PK__transfer__3213E83F7202F297");
    ...
    {
        projectConfiguration.HasKey(e => e.Id).HasName("PK__dao_revo__3213E83F319BDBD1");
