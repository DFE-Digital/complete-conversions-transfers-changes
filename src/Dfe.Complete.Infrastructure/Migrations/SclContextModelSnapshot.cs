...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dfe.Complete.Domain.Entities.Schools.PrincipalDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Dfe.Complete.Domain.Entities.Schools.School", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Dfe.Complete.Domain.Entities.Schools.School", b =>
                {
                    b.HasOne("Dfe.Complete.Domain.Entities.Schools.PrincipalDetails", "PrincipalDetails")
                        .WithOne()
                        .HasForeignKey("Dfe.Complete.Domain.Entities.Schools.School", "PrincipalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Dfe.Complete.Domain.Entities.Schools.School.NameDetails#Dfe.Complete.Domain.ValueObjects.NameDetails", "NameDetails", b1 =>
                        {
