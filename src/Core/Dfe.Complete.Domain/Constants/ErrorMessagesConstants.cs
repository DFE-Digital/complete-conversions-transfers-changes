namespace Dfe.Complete.Domain.Constants
{
    public static class ErrorMessagesConstants
    {
        ...
        public const string CouldNotDeleteExternalContact = "Could not delete external contact with Id {ContactId}.";
        public const string NotFoundExternalContact = "External contact with Id {ContactId} not found.";
