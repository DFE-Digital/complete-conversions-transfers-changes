        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    handover_confirm_sacre_exemption = table.Column<bool>(type: "bit", nullable: true),
                    ...
                    receive_grant_payment_certificate_not_applicable = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_GiasEstablishments_Urn", x => x.urn);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    entra_user_object_id = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    regional_delivery_officer_id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    team = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    two_requires_improvement = table.Column<bool>(type: "bit", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_projects_gias_establishments_urn",
                        column: x => x.urn,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_significant_date_histories_users_user_id",
                        column: x => x.user_id,
                        principalSchema: "complete",
                        principalTable: "users",
                        principalColumn: "id");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_significant_date_history_reasons_significant_date_histories_significant_date_history_id",
                        column: x => x.significant_date_history_id,
                        principalSchema: "complete",
                        principalTable: "significant_date_histories",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GiasEstablishments_Urn",
                schema: "complete",
                table: "gias_establishments",
                column: "urn",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_significant_date_histories_user_id",
                schema: "complete",
                table: "significant_date_histories",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "IX_significant_date_history_reasons_significant_date_history_id",
                schema: "complete",
                table: "significant_date_history_reasons",
                column: "significant_date_history_id");

            migrationBuilder.CreateIndex(
                name: "UQ_users_entra_user_object_id",
                schema: "complete",
                table: "users",
                column: "entra_user_object_id",
                unique: true,
                filter: "[entra_user_object_id] IS NOT NULL");
        }
