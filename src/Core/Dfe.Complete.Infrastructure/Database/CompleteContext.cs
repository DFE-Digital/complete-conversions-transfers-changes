...
public partial class CompleteContext : DbContext
{
    ...
    private static void ConfigureConversionTasksData(EntityTypeBuilder<ConversionTasksData> projectConfiguration)
    {
        ...
        projectConfiguration.Property(e => e.CheckAccuracyOfHigherNeedsFundedPlacesRequired).HasColumnName("check_accuracy_of_higher_needs_funded_places_required");
        projectConfiguration.Property(e => e.CheckAccuracyOfHigherNeedsAcknowledgeLAMustConfirm).HasColumnName("check_accuracy_of_higher_needs_acknowledge_la_must_confirm");
