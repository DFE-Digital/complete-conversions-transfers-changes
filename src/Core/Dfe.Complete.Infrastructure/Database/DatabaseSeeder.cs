...
public class DatabaseSeeder(CompleteContext context, IConfiguration configuration)
{
    ...
    public static IReadOnlyList<Urn> Urns => [
        new Urn(100006), new Urn(100127), new Urn(100129), new Urn(100204), new Urn(100283), new Urn(100352), new Urn(100468), 
        new Urn(102041), new Urn(102776), new Urn(103748), new Urn(103835), new Urn(103839), new Urn(103844), new Urn(103847), 
        new Urn(103886), new Urn(103888), new Urn(104801), new Urn(105601), new Urn(105603), new Urn(105944), new Urn(106859), 
        new Urn(106982), new Urn(107778), new Urn(107780), new Urn(107781), new Urn(107786), new Urn(107793), new Urn(107794), 
        new Urn(108410), new Urn(108590), new Urn(100830), new Urn(103845), new Urn(103846), new Urn(105602), new Urn(107779), 
        new Urn(107787), new Urn(107789), new Urn(108591), new Urn(108592), new Urn(108593), new Urn(108635), new Urn(108638), 
        new Urn(108887), new Urn(108888), new Urn(108889), new Urn(113536), new Urn(123482), new Urn(123484), new Urn(123487), 
        new Urn(123494), new Urn(135584), new Urn(135587), new Urn(136732), new Urn(143659), new Urn(147800), new Urn(147801), 
        new Urn(149460)
    ];
    
    public static IReadOnlyList<string> EstablishmentNames => ["Heath School", "Gordon Primary School", "Haimo Primary School", "King's Oak School", "The Skinners' Company's School for Girls", "St Peter's Primary School", "Colebrooke School", "Latymer All Saints CofE Primary School", "Little Ilford School", "Davenport Lodge School", "Church of the Ascension CofE Primary School", "Oldswinford C of E Primary School", "St Chad's Catholic Primary School", "Halesowen CofE Primary School", "Batmans Hill Nursery School", "Batmans Hill Unit", "St Peter's CofE Primary School", "Abbey College Manchester", "Bollin Cross School", "St Philip's CofE Primary School", "Aston Fence Junior and Infant School", "Abbey Lane Primary School", "Spen Valley High School", "Whitcliffe Mount School", "Gomersal Church of England Voluntary Controlled Middle School", "Huddersfield Grammar School", "Islamia Girls' High School", "Madni Academy", "Kingsmeadow Community School", "Coquet Park First School", "St John's and St Clement's Church of England Primary School", "Jesson's CofE Primary School (VA)", "Cradley CofE Primary School", "Manchester Hospital School", "Grylls Community Middle School", "The Mount School", "Mountjoy House School", "Langley First School", "Carville Primary School", "Western First School", "Marden Bridge Middle School", "Whitley Bay High School", "Carn Gwaval CofE School", "St Agnes CofE VC Primary School", "Tresco Church of England Primary School", "Hele's School", "Longnor CofE Primary School", "Morda CofE Primary School", "Myddle CofE Primary School", "Prees CofE Primary School", "Ark Globe Academy", "City of London Academy Islington", "Queen Elizabeth Grammar School Penrith", "City of London Academy, Highgate Hill", "Whitchurch Primary School", "St Mark's CofE School", "Priory Rise School"];
