...
{
    public record UpdateIncomingTrustCEOContactTaskCommand(
        ProjectId ProjectId,
        ContactId ContactId) : IRequest<Result<bool>>;

    internal class UpdateIncomingTrustCEOContactTaskCommandCommandHandler(
