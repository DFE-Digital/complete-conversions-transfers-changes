...
{
    public async Task<Result<bool>> Handle(UpdateRegionalDeliveryOfficerCommand request,
        CancellationToken cancellationToken)
    {
        ...
        return success.RegionalDeliveryOfficerId != request.RegionalDeliveryOfficer
            ? Result<bool>.Failure("User has not been updated")
