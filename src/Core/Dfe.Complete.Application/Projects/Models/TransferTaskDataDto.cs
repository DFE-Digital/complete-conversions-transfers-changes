...
{
    public class TransferTaskDataDto
    {
        ...
        public DateOnly? ConfirmDateAcademyTransferredDateTransferred { get; set; }

        public bool? SponsoredSupportGrantNotApplicable { get; set; }

        public string? SponsoredSupportGrantType { get; set; }

        public DateOnly? DeclarationOfExpenditureCertificateDateReceived { get; set; }
        ...
        public bool? ConditionsMetCheckAnyInformationChanged { get; set; }

        public bool? ConditionsMetBaselineSheetApproved { get; set; }

        public bool? FormMNotApplicable { get; set; }
