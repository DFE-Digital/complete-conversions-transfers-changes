...
namespace Dfe.Complete.Client.Contracts
{
    ...
    public partial interface IContactsClient
    {
        ...
        /// <returns>Contact</returns>
        /// <exception cref="CompleteApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Contact> GetMpContactForConstituencyAsync(string? constituency);
        ...
        /// <returns>Contact</returns>
        /// <exception cref="CompleteApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Contact> GetMpContactForConstituencyAsync(string? constituency, System.Threading.CancellationToken cancellationToken);
