...
{
    public class UpdateConfirmAcademyOpenedDateTaskCommandTests
    {
        [Theory]
       ...
       )
        {
            ...
            var handler = new UpdateConfirmAcademyOpenedDateTaskCommandHandler(taskDataReadRepository, taskDataWriteRepository);
