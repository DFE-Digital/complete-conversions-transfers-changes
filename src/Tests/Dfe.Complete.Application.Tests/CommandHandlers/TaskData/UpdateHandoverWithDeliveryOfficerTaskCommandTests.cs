...
{
    public class UpdateHandoverWithDeliveryOfficerTaskCommandTests
    {
        [Theory]
        ...
        )
        {
            ...
            var handler = new UpdateHandoverWithDeliveryOfficerTaskCommandHandler(taskDataReadRepository, taskDataWriteRepository);
            ...
            UpdateHandoverWithDeliveryOfficerTaskCommand command)
        {
            ...
            var handler = new UpdateHandoverWithDeliveryOfficerTaskCommandHandler(
