...
{
    public class UpdateChurchSupplementalAgreementTaskCommandTests
    {
        [Theory]
        ...
        )
        {
            ...
            var handler = new UpdateChurchSupplementalAgreementTaskCommandHandler(taskDataReadRepository, taskDataWriteRepository);
            ...
            UpdateChurchSupplementalAgreementTaskCommand command)
        {
            ...
            var handler = new UpdateChurchSupplementalAgreementTaskCommandHandler(
