...
{
    public class UpdateRedactAndSendDocumentsTaskCommandTests
    {
        [Theory]
        ...
        )
        {
            ...
            var handler = new UpdateRedactAndSendDocumentsTaskCommandHandler(taskDataReadRepository, taskDataWriteRepository);
            ...
            UpdateRedactAndSendDocumentsTaskCommand command)
        {
            ...
            var handler = new UpdateRedactAndSendDocumentsTaskCommandHandler(
