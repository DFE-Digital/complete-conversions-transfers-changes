...
{
    public class UpdateCommercialAgreementTaskCommandTests
    {
        [Theory]
        ...
        )
        {
            ...
            var handler = new UpdateCommercialAgreementTaskCommandHandler(taskDataReadRepository, taskDataWriteRepository);
            ...
            UpdateCommercialAgreementTaskCommand command)
        {
            ...
            var handler = new UpdateCommercialAgreementTaskCommandHandler(
