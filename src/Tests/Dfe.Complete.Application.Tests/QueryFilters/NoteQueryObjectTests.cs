...
namespace Dfe.Complete.Application.Tests.QueryFilters
{
    public class NoteQueryObjectTests
    {
        ...
        private static IQueryable<Note> SampleNotes() => new[]
        {
            ...
            new Note { Id = GetNoteId(), ProjectId = new ProjectId(Guid.Parse("00000000-0000-0000-0000-000000000002")), TaskIdentifier = NoteTaskIdentifier.LandQuestionnaire.ToDescription() },
            new Note { Id = GetNoteId(), ProjectId = new ProjectId(Guid.Parse("00000000-0000-0000-0000-000000000002")), TaskIdentifier = NoteTaskIdentifier.AcademyDetails.ToDescription() },
            ...
            new Note { Id = GetNoteId(), ProjectId = new ProjectId(Guid.Parse("00000000-0000-0000-0000-000000000003")), TaskIdentifier = NoteTaskIdentifier.ArticleOfAssociation.ToDescription() }
        }.AsQueryable();
