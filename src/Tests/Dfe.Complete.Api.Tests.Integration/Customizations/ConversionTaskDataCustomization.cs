...
public class ConversionTaskDataCustomization : ICustomization
{
    public void Customize(IFixture fixture)
    {
        ...
        fixture.Customize<ConversionTasksData>(composer => composer
            ...
            .With(x => x.ChurchSupplementalAgreementDraftSaved, false)
            .With(x => x.ChurchSupplementalAgreementFinalSaved, false)
            .With(x => x.ChurchSupplementalAgreementSignedTrust, false)
            ...
            .With(x => x.ThirdPartyLeasesEmail, false)
            .With(x => x.ThirdPartyLeasesNotApplicable, false)
            .With(x => x.ThirdPartyLeasesReceive, false)
            .With(x => x.ThirdPartyLeasesSave, false)
