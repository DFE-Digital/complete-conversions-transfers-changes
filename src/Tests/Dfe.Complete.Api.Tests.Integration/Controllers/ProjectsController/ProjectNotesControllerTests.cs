...
public partial class ProjectsControllerTests
{
    ...
    [CustomAutoData(
        typeof(CustomWebApplicationDbContextFactoryCustomization))]
    public async Task UpdateProjectNoteAsync_UserIsUnauthorized_ShouldReturnUnauthorized(
        CustomWebApplicationDbContextFactory<Program> factory,
        IFixture fixture,
        IProjectsClient projectsClient)
    {
        ...
        var exception = await Assert.ThrowsAsync<CompleteApiException>(() =>
            projectsClient.UpdateProjectNoteAsync(command));

        Assert.Equal(401, (int)exception.StatusCode);
        Assert.Contains("Could not update note", exception.Message);
    }
    ...
    [CustomAutoData(
        ...
        typeof(ProjectCustomization),
        typeof(NoteCustomization))]
    public async Task UpdateProjectNoteAsync_UserIsNotAuthor_ShouldReturnUnauthorized(
        CustomWebApplicationDbContextFactory<Program> factory,
        IFixture fixture,
        IProjectsClient projectsClient)
    {
        ...
        factory.TestClaims = [
            ...
            new Claim(ClaimTypes.Role, ApiRoles.ReadRole),
            new Claim(ClaimTypes.Role, ApiRoles.UpdateRole),
            new Claim(CustomClaimTypeConstants.UserId, new Guid().ToString()),
        ];
    ...
    [CustomAutoData(
        typeof(CustomWebApplicationDbContextFactoryCustomization))]
    public async Task DeleteProjectNoteAsync_UserIsUnauthorized_ShouldReturnUnauthorized(
        CustomWebApplicationDbContextFactory<Program> factory,
        IFixture fixture,
        IProjectsClient projectsClient)
    {
        ...
        // Act & Assert
        var exception = await Assert.ThrowsAsync<CompleteApiException>(() =>
            projectsClient.DeleteProjectNoteAsync(command));

        Assert.Equal(401, (int)exception.StatusCode);
        Assert.Contains("Could not delete note", exception.Message);
    }
    ...
    [CustomAutoData(
        ...
        typeof(ProjectCustomization),
        typeof(NoteCustomization))]
    public async Task DeleteProjectNoteAsync_UserIsNotAuthor_ShouldReturnUnauthorized(
        CustomWebApplicationDbContextFactory<Program> factory,
        IFixture fixture,
        IProjectsClient projectsClient)
    {
