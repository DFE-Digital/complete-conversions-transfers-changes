...
{
    public class UpdateLandConsentLetterTaskTests
    {
        [Theory]
        [CustomAutoData(
            typeof(CustomWebApplicationDbContextFactoryCustomization),
            typeof(TransferTaskDataCustomization))]
        public async Task UpdateLandConsentLetterTaskAsync_ShouldUpdate_TransferTaskData(
            ...
            IFixture fixture)
        {
            ...
            // Act
            await tasksDataClient.UpdateLandConsentLetterTaskAsync(command, default);
        ...
        public async Task UpdateLandConsentLetterTaskAsync_ShouldUpdateNotApplicableOnly(
            CustomWebApplicationDbContextFactory<Program> factory,
            ITasksDataClient tasksDataClient,
            IFixture fixture)
        {
        ...
        public async Task UpdateLandConsentLetterTaskAsync_ShouldFail_WhenTaskDataIdNotMatched(
            CustomWebApplicationDbContextFactory<Program> factory,
            ITasksDataClient tasksDataClient,
            IFixture fixture)
        {
            ...
            // Act + Assert
            var exception = await Assert.ThrowsAsync<NotFoundException>(() => tasksDataClient.UpdateLandConsentLetterTaskAsync(command, default));
