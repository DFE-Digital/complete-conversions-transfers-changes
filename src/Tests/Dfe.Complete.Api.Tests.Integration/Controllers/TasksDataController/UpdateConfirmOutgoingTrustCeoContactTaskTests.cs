...
{
    public class UpdateConfirmOutgoingTrustCeoContactTaskTests
    {
        [Theory]
        [CustomAutoData(typeof(CustomWebApplicationDbContextFactoryCustomization), typeof(OmitCircularReferenceCustomization))]
        public async Task UpdateConfirmOutgoingTrustCeoContactTaskAsync_ShouldUpdate_KeyContact(
            ...
            IFixture fixture)
        {
            ...
            // Act
            await tasksDataClient.UpdateConfirmOutgoingTrustCeoContactTaskAsync(command, default);
