...
namespace Dfe.Complete.Api.Tests.Integration.Controllers.TasksDataController
{
    public class UpdateAccuracyOfHigherNeedsTaskTests
    {
        ...
        public async Task UpdateAccuracyOfHigherNeedsTaskAsync_ShouldFail_WhenTaskDataIdNotMatched(
            CustomWebApplicationDbContextFactory<Program> factory,
            ITasksDataClient tasksDataClient,
            IFixture fixture)
        {
            ...
            // Act + Assert
            var exception = await Assert.ThrowsAsync<NotFoundException>(() => tasksDataClient.UpdateAccuracyOfHigherNeedsTaskAsync(command, default));
