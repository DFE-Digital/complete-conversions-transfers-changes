...
public class UserInfoTests
{
    ...
    public void ToHeadersKVP_When_NameSet_Returns_Name_Header()
    {
        ...
        var nameResult = results.FirstOrDefault(x =>
            string.Equals(x.Key, "x-user-context-name", StringComparison.InvariantCultureIgnoreCase));
    ...
    public void ToHeadersKVP_When_Name_And_Roles_Set_Returns_Role_Headers()
    {
        ...
        var results = sut.ToHeadersKVP();
        var roleResults = results.Where(x =>
            x.Key.StartsWith("x-user-context-role-", StringComparison.InvariantCultureIgnoreCase)).ToArray();
    ...
    [InlineData("X-user-CONTEXT-NAME", "X-user-CONTEXT-ROLE-0", "X-user-CONTEXT-ROLE-1", "X-user-CONTEXT-ROLE-2",
        "X-user-AD-ID")]
    public void FromHeaders_Is_Case_Insensitive_And_Returns_Populated_UserInfo(string nameHeader,
        string roleHeader1, string roleHeader2, string roleHeader3, string aDHeader)
    {
    ...
    [Fact]
    public void FromHeaders_When_ActiveDirectoryKey_Null_Sets_ActiveDirectoryId()
    {
