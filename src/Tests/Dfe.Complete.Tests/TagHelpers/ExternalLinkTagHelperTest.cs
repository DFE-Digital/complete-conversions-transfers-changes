...
public class ExternalLinkTagHelperTest
{
    ...
    public void Process_WithContentAlreadyContainingOpensIn_DoesNotAddDuplicateText()
    {
        ...
        var output = new TagHelperOutput(
            ...
            attributes: new TagHelperAttributeList(),
            getChildContentAsync: (useCachedResult, encoder) =>
                Task.FromResult(new DefaultTagHelperContent().SetContent("Link opens in new tab")));
        ...
        Assert.Equal(2, content.Split("opens in", StringSplitOptions.RemoveEmptyEntries).Length);
    }
