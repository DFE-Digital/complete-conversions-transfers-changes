...
namespace Dfe.Complete.Tests.Models
{
    public class TransferTaskListViewModelTests
    {
        ...
        [InlineData(false, null, true, null, null, TaskListStatus.InProgress)]
        [InlineData(null, null, true, null, null, TaskListStatus.InProgress)]
        [InlineData(null, true, false, true, false, TaskListStatus.InProgress)]
        [InlineData(false, true, false, true, false, TaskListStatus.InProgress)]
        [InlineData(false, true, true, false, false, TaskListStatus.InProgress)]
