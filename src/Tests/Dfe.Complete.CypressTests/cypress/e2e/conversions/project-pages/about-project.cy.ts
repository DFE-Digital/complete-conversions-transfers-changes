...
describe("About the project page - conversion projects: ", () => {
    ...
    it("Should be able to make changes to your project's (MAT) details", () => {
        ...
        editConversionProjectPage
            ...
            .withDecisionDate("28", "02", "2023")
            .withDecisionConditions("New decision conditions")
        ...
        aboutTheProjectPage
            ...
            .subSection("Decision details")
            .keyHasValue("Date of decision", "28 February 2023")
            .keyHasValue("Conditions of the decision", "New decision conditions")
            .subSection("School details")
            .keyHasValueWithLink(
                "SharePoint folder",
                "View the school SharePoint folder (opens in new tab)",
