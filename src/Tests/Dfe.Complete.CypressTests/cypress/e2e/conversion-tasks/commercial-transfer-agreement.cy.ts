...
describe("Conversion tasks - Commercial transfer agreement", () => {
    ...
    it("should show task status based on the checkboxes that are checked", () => {
        ...
        TaskHelper.updateCommercialTransferAgreement(taskId, ProjectType.Conversion, "notStarted");
        cy.reload();
        taskListPage.hasTaskStatusNotStarted("Commercial transfer agreement");

        TaskHelper.updateCommercialTransferAgreement(taskId, ProjectType.Conversion, "inProgress");
        cy.reload();
        taskListPage.hasTaskStatusInProgress("Commercial transfer agreement");

        TaskHelper.updateCommercialTransferAgreement(taskId, ProjectType.Conversion, "completed");
        cy.reload();
