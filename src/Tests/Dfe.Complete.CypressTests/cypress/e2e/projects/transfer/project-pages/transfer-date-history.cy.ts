...
const confirmedDateProject = ProjectBuilder.createTransferProjectRequest({
    urn: { value: urnPool.transfer.batmans },
...
describe("View the transfer date history tests", () => {
    ...
    it("Should be able to view the transfer date history for a project", () => {
        ...
        dateHistoryPage
            ...
            .hasReasonNewDate("Academy", reasonsForChange1.Academy)
            ...
            .hasReasonNewDate("Outgoing trust", reasonsForChange1.OutgoingTrust)
