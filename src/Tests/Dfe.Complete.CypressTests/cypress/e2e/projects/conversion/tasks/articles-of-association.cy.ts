...
describe("Conversion tasks - Articles of association", () => {
    ...
    it("should show task status based on the checkboxes are checked", () => {
        ...
        taskApi.updateArticleOfAssociationTask(taskId, ProjectType.Conversion);
        taskListPage.hasTaskStatusNotStarted("Articles of association");

        taskApi.updateArticleOfAssociationTask(taskId, ProjectType.Conversion, true);
        cy.reload();
        taskListPage.hasTaskStatusNotApplicable("Articles of association");

        taskApi.updateArticleOfAssociationTask(taskId, ProjectType.Conversion, false, true);
        cy.reload();
        taskListPage.hasTaskStatusInProgress("Articles of association");

        taskApi.updateArticleOfAssociationTask(taskId, ProjectType.Conversion, false, true, true, true, true, true);
        cy.reload();
