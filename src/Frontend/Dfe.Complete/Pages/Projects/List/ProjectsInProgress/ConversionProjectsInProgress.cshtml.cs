...
public class ConversionProjectsInProgressInProgressModel(ISender sender) : ConversionOrTransferInProgressModel(ConversionsSubNavigation, ProjectType.Conversion)
{
