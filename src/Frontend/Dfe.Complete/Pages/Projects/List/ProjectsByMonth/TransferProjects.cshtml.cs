...
{
    public class TransferProjectsByMonthModel(ISender sender) : ProjectsByMonthModel(TransfersSubNavigation)
    {
        ...
        public async Task OnGet()
        {
            ...
            var listProjectQuery = new ListProjectsByMonthQuery(Month, Year, ProjectState.Active, ProjectType.Transfer, PageNumber-1, PageSize);
