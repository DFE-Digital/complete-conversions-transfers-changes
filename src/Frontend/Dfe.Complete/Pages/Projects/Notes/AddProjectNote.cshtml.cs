...
public class AddProjectNoteModel(ISender sender, ErrorService errorService, ILogger<AddProjectNoteModel> _logger) : BaseProjectNotesModel(sender, _logger, NotesNavigation)
{
