...
{
    public class ChurchSupplementalAgreementTaskModel(ISender sender, IAuthorizationService authorizationService, ILogger<ChurchSupplementalAgreementTaskModel> logger, IProjectPermissionService projectPermissionService)
    : BaseProjectTaskModel(sender, authorizationService, logger, NoteTaskIdentifier.ChurchSupplementalAgreement, projectPermissionService)
    {
