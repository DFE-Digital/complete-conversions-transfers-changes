...
namespace Dfe.Complete.Pages.Projects.TaskList.Tasks.ConfirmIncomingTrustCeoContactTask;

public class ConfirmIncomingTrustCeoContactTaskModel(ISender sender) : BaseProjectPageModel(sender)
{
