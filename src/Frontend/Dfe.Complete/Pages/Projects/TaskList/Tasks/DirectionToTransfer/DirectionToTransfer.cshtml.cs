...
{
    public class DirectionToTransferModel(ISender sender, IAuthorizationService authorizationService, ILogger<DirectionToTransferModel> logger, IProjectPermissionService projectPermissionService)
    : BaseProjectTaskModel(sender, authorizationService, logger, NoteTaskIdentifier.DirectionToTransfer, projectPermissionService)
    {
