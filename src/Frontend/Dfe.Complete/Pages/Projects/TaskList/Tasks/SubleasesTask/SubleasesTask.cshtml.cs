...
{
    public class SubleasesTaskModel(ISender sender, IAuthorizationService authorizationService, ILogger<SubleasesTaskModel> logger, IProjectPermissionService projectPermissionService)
    : BaseProjectTaskModel(sender, authorizationService, logger, NoteTaskIdentifier.Subleases, projectPermissionService)
    {
