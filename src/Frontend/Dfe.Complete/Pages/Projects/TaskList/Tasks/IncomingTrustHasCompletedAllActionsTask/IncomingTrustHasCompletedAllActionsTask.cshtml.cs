...
{
    public class IncomingTrustHasCompletedAllActionsTaskModel(ISender sender, IAuthorizationService authorizationService, ILogger<IncomingTrustHasCompletedAllActionsTaskModel> logger, IProjectPermissionService projectPermissionService)
    : BaseProjectTaskModel(sender, authorizationService, logger, NoteTaskIdentifier.ConfirmIncomingTrustHasCompletedAllActions, projectPermissionService)
    {
        [BindProperty]
